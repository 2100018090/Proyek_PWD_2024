            ...
            <div class = "payments">
                ...
                <table>
                    ...
                    require '../../koneksi.php';
                        ...
                        echo '<td><a href="proses/transaksi_u.php?id=' . $user_data['id_transaksi'] . '" class="btn" id="editButton">Update</a></td>';
                        echo '<td><a href="proses/transaksi_d.php?id=' . $user_data['id_transaksi'] . '" class="btn" id="deleteButton">Delete</a></td>';
                        echo "</tr>";
                        }
                     ?>
                </table>
