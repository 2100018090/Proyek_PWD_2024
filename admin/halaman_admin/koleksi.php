        ...
        <div class="content">
            ...
            <div class="content-2">
                <div class="payments">
                    <div class="title">
                        <h2>Data Koleksi</h2>
                        <a href="tambah_koleksi.php" class="btn">Tambah Koleksi</a>
                    </div>
                    <table>
                        <tr>
                        ...
                        $result = mysqli_query($con, "SELECT * FROM koleksi");
                        while ($user_data = mysqli_fetch_array($result)) {
                            $gambar_koleksi = $user_data['gambar_koleksi'];                         
                            echo "<tr>";
                            echo "<td>" . $user_data['gambar_koleksi'] . "</td>";
                            echo '<td><a href="proses/koleksi_u.php?id=' . $user_data['id_koleksi'] . '" class="btn" id="editButton">Update</a></td>';
                            echo '<td><a href="proses/koleksi_d.php?id=' . $user_data['id_koleksi'] . '" class="btn" id="deleteButton">Delete</a></td>';
                            echo "</tr>";
                        }
                        ?>
                    </table>
