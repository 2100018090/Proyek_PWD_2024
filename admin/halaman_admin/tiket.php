            ...
            <div class = "payments">
                ...
                <table>
                    ...
                    require '../../koneksi.php';
                        ...
                        echo '<td><a href="proses/tiket_u.php?id=' . $user_data['id_tiket'] . '" class="btn" id="editButton">Update</a></td>';
                        echo '<td><a href="proses/tiket_d.php?id=' . $user_data['id_tiket'] . '" class="btn" id="deleteButton">Delete</a></td>';
                        echo "</tr>";
                        }
                     ?>
                </table>
