                ...
                <div class="col-md-12 col-lg-10">
                    <div class="wrap d-md-flex">
                        ...
                        <form action="#" method="post" class="signin-form">
                            ...
                            <div class="form-group mb-3">
                                <label class="label" for="password"><?php echo $passwordErr; ?></label>
                                <input type="password" class="form-control" placeholder="Password" fdprocessedid="rluudv" name="password" id="password">
                            </div>

                            <div class="form-group">
                                <button type="submit" class="form-control btn btn-primary rounded submit px-3" fdprocessedid="sh478o" name = "register">Mulai</button>
                            </div>
                            </div>
                        </form>
                    </div>
