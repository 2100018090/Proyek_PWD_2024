				...
				<div class="container">
					<div class="row fullscreen d-flex align-items-center justify-content-center">
						<div class="banner-content col-lg-8">
							...
							Selamat datang di web museum kami, tempat di mana sejarah dan teknologi bertemu. 
							Jelajahi kisah-kisah inspiratif, artefak berharga, dan peristiwa bersejarah yang 
							membentuk peradaban kita. Kami juga hadir dalam dunia nyata dengan museum offline 
							kami. Selamat menikmati eksplorasi Anda.
							</p>
							<a href="ticket.php" class="primary-btn text-uppercase">Beli Ticket</a>
						</div>											
					</div>
				</div>					
			</section>
